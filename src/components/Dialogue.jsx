        ...
        <DialogContent>
          ...
          <div className="flex items-center gap-4 my-4">
            ...
            <p className="bg-gray-200 text-black p-4 flex-1">
              By selecting a hospitality event, you acknowledge and agree that
              payment will be invoiced in GBP and is due within 15 days of
              receipt. Payments are non-refundable unless the event is cancelled
              by the organizer. For more information on how we handle your data,
